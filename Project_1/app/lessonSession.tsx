            ...
            <View style={styles.container}>
                ...
                <ScrollView contentContainerStyle={styles.scrollContent}>
                    <View style={styles.promptContainer}>
                        <Text style={styles.promptHelperText}>
                            {currentQuestion.questionType === 'meaning_to_word' ? 'Which word means:' : 'What is the meaning of:'}
                        </Text>
                ...
                {selectedAnswer && (
                    <View style={[styles.footer, isCorrect ? styles.footerCorrect : styles.footerIncorrect]}>
                        ...
                        <TouchableOpacity style={styles.continueButton} onPress={handleContinueQuiz}>
...
const styles = StyleSheet.create({
    ...
    promptContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', marginBottom: 40 },
